...
To only route to an exact match of what is programmed
1. How would you explain form validation to someone who has never programmed before?
Validation is a way to make sure that information is correctly sent/received.
1. In 1-2 sentences, define end to end testing.
End testing is a way to ensure that your program does everything you are wanting it to. 
